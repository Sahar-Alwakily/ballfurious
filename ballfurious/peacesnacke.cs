...
{
    public partial class peacesnacke : Form
    {
        ...
        private void peacesnacke_Load(object sender, EventArgs e)
        {
            if (s == 1)
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (PlayerTurn == true)
            {
                ...
                #endregion
                #region laddar ادا لاعب 2 صعد الى سلم
                switch (Player1Locat)
                {
                    case 3:
                ...
                if (Player1Locat >= 55 && Player1Locat <= 65)
                {
                    ...
                    {
                        peacesnacke myNewForm = new peacesnacke(s);
                        this.Hide();
